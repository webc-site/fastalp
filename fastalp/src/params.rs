...
/// 参数位域掩码与位移常量
pub(crate) const EXP_MASK: u16 = 0x001F;
pub(crate) const FAC_SHIFT: u16 = 5;
pub(crate) const FAC_MASK: u16 = 0x000F;
pub(crate) const BIT_WIDTH_SHIFT: u16 = 9;
pub(crate) const BIT_WIDTH_MASK: u16 = 0x007F;

/// Packs exponent (5b), factor (4b), and bit width (7b) into a 2-byte unsigned integer.
/// 将 exp (5b), fac (4b), bit_width (7b) 打包进 2 字节 u16
#[inline(always)]
pub(crate) const fn pack_params(exp: u8, fac: u8, bit_width: u8) -> u16 {
  ((exp as u16) & EXP_MASK)
...
#[inline(always)]
pub(crate) const fn unpack_params(params: u16) -> (u8, u8, u8) {
...
#[inline(always)]
pub(crate) const fn bits_needed(max_val: u64) -> u8 {
...
/// 快速计算 0..=64 比特宽度的低位掩码
#[inline(always)]
pub(crate) const fn bit_mask(bit_width: u8) -> u64 {
